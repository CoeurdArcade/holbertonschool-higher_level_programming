...
@ubuntu:~/$ ./2-args.py Hello Welcome To The Best School
6 arguments:
1: Hello
2: Welcome
3: To
...
Write a program that prints the result of the addition of all arguments
    ...
    Your code should not be executed when imported
@ubuntu:~/$ ./3-infinite_add.py 79 10 -40 -300 89 
-162
...
@ubuntu:~/$ ./100-my_calculator.py ; echo $?
Usage: ./100-my_calculator.py <a> <operator> <b>
1
@ubuntu:~/$ ./100-my_calculator.py 3 + 5 ; echo $?
3 + 5 = 8
0
@ubuntu:~/$ ./100-my_calculator.py 3 H 5 ; echo $?
...
@ubuntu:~/$ ./103-fast_alphabet.py
ABCDEFGHIJKLMNOPQRSTUVWXYZ
@ubuntu:~/$ wc -l 103-fast_alphabet.py
